...
/**
 * Communication Channels Migration
 * 
 * This migration creates all channel-related tables for different communication platforms:
 * - Web Widget Channel
 * - Email Channel
 * - API Channel
 * - WhatsApp Channel
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // WhatsApp Channel
        Schema::create('channel_whatsapp', function (Bluepr