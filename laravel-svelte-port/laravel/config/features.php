 ...
 * 
 * Laravel-native feature configuration that maintains parity with Rails features.yml
 * but uses Laravel conventions and patterns.
 */
...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Complete list of features matching Rails config/features.yml
    | Using Laravel array format instead of YAML
    |
    */
