...
<div class="absolute top-full mt-1.5 max-h-120 overflow-y-auto left-0 flex flex-col gap-4 px-4 pt-6 pb-5 items-start w-115 h-auto bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-lg rounded-lg z-50">
  <div class="w-full">
